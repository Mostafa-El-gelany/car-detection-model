...
# Initialize EasyOCR reader once, even if this file contains duplicated blocks.
if 'reader' not in globals():
    reader = easyocr.Reader(['en'])  # Initialize with English language

# Load pretrained YOLOv5 model once.
...
# [{'color': 'black', 'text': 'No text detected', 'coordinates': (1065, 98, 1800, 439), 'confidence': 0.9274440407752991}, 
#  {'color': 'purple', 'text': 'HOBaG0327', 'coordinates': (68, 106, 886, 449), 'confidence': 0.923507034778595},
#  {'color': 'blue', 'text': 'No text detected', 'coordinates': (74, 637, 898, 978), 'confidence': 0.9209210276603699}, 
#  {'color': 'black', 'text': 'No text detected', 'coordinates': (1013, 650, 1860, 984), 'confidence': 0.9016231894493103}]